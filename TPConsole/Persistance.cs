...
namespace TPConsole
{
    public static class Persistance
    {
        ...
        {
            public string DataVersion { get; init; } = "DG-2.0";

            public decimal MontantTirelire1 { get; init; }
            public decimal MontantTirelire2 { get; init; }

            public Instances MesInstances { get; init; } = new();
        }
        ...
        public static void Sauvegarder()
        {
            ...
            string jsonString =
                JsonSerializer.Serialize(programData, options);
        ...
        public static void Charger()
        {
            ...
            if (programData?.MesInstances is not null && programData.DataVersion == "DG-2.0")
            {
